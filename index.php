...
<head>
  ...
  <title>YT Thumbnail Downloader | NT Technical</title>
...
<body>
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    ...
    <div class="url-input">
      ...
      <div class="field">
        <input type="text" placeholder="https://www.youtube.com/@NT_WebDeveloper" required>
    ...
    <div class="preview-area">
      ...
      <span>Paste video url To see Thumbnail</span>
    </div>
